...
//Вообще фигня какая-то. факториальное число хранить в стоке??? а как ты поймешь сколько разрядов на какой коэфициент нужно? (кто сказал что коэфициенты только от 0 до 9???)
//зачем вообще нужен класс который переставлет пять букв?
